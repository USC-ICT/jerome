...
#ifndef icu_tokenizer_hpp
#define icu_tokenizer_hpp
...
namespace jerome {
  namespace icu {
    ...
    private:
      ...
      optional<value_type> get_next() {
        ...
        ++mIterator;
        return value_type(String(start->iterator(), mIterator->iterator())
  ...
  using tokenized_stream = icu::tokenized_stream;
}

#endif

#endif // defined icu_tokenizer_hpp
