...
//			typedef int type;
  ...
  template <typename T, typename... Ts, std::size_t N, std::size_t... Ns>
  auto tail_impl(const std::tuple<T, Ts...>& t, index_sequence<N, Ns...>)
  {
  ...
  {
    return tail_impl(t, make_index_sequence<sizeof...(Ts)>());
  }
